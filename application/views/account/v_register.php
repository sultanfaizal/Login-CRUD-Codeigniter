		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="password_conf" placeholder="Password Confirmation" value="<?php echo set_value('password_conf'); ?>" />
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" name="btnSubmit" value="Register" />
							DAFTAR
						</button>
					...
					<div class="text-center p-t-136">
							...
							<u><?php echo anchor(site_url().'/login','login'); ?></u>
						</a>
					</div>
				</div>
			</div>
